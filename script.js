const translations = {
  de: {
    ...
    detail1Text: 'Der Abend beginnt mit einem ruhigen Übergang aus dem Außen in einen privaten und stimmigen Rahmen.',
    detail2Title: 'Gemeinsame Zeit',
    ...
    faq1A: 'Nein. Maison de Minuit ist als privates Date-Erlebnis gedacht und nicht als Hotel- oder Übernachtungskonzept positioniert.',
    faq2Q: 'Sind alle Bereiche zugänglich?',
  ...
  en: {
    ...
    detail1Text: 'The evening begins with a calm transition from the outside world into a private and composed setting.',
    detail2Title: 'Shared time',
    ...
    faq1A: 'No. Maison de Minuit is designed as a private date experience and not positioned as a hotel or overnight concept.',
    faq2Q: 'Are all areas accessible?',
